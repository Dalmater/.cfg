...
" nnoremap <local><leader> :<c-u>WhichKey  '\'<CR>
" vnoremap <local><leader> :<c-u>WhichKeyVisual  '\'<CR>
...
let g:which_key_map['g'] = { 'name': '+git +goyo +Rg_word +F open_file' }
let g:which_key_map['h'] = { 'name': 'hsearch +fzf +hor→vert_split' }
let g:which_key_map['j'] = { 'name': 'moves line down' }
let g:which_key_map['k'] = { 'name': 'moves line up' }
let g:which_key_map['l'] = { 'name': '+ls +Locate' }
let g:which_key_map['o'] = { 'name': '+(c+l)open' }
let g:which_key_map['r'] = { 'name': '+g Rg +o Root' }
let g:which_key_map['s'] = { 'name': '+split +spell +source +shebang +ruler' }
