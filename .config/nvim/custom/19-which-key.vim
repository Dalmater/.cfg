...
let g:which_key_map['a'] = { 'name': '+format +argadd +ag' }
...
let g:which_key_map.t.e = 'expand file dir in cmd line'
...
let g:which_key_map['S'] = 'substitute'
...
"       \| autocmd BufLeave <buffer> set ls=2 nosmd
