...
hi def link zshMathSubst        Number
hi def link zshOldSubst         Special
hi def link zshSubstDelim       zshSubst
hi def link zshGlob             Number
