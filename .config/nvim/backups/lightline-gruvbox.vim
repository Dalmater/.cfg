...
let s:p.insert.right = [ [ s:base01, s:green ], [ s:base3, s:base0 ] ]
let s:p.insert.middle = [ [ s:base2, s:base01 ] ]

let s:p.replace.left = [ [ s:base04, s:orange], [ s:base4, s:base00 ] ]
let s:p.replace.right = [ [ s:base01, s:orange ], [ s:base3, s:base0 ] ]
let s:p.replace.middle = [ [ s:base2, s:base01 ] ]

let s:p.visual.left = [ [ s:base04, s:peach ], [ s:base4, s:base01 ] ]
let s:p.visual.right = [ [ s:base04, s:base0 ], [ s:base2, s:base01 ] ]
