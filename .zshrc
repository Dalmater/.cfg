...
export FZF_DEFAULT_COMMAND='ag --hidden --color --ignore .git -g ""'
export FZF_DEFAULT_OPTS="--height 80% --color='bg:000,bg+:236,info:136,border:240,spinner:108,hl:65,fg:250,header:65,fg+:252,pointer:124,marker:168,prompt:136,hl+:108' --layout=reverse --border --info=inline --bind=alt-T:toggle"
...
plugins=( extract nice-exit-code title
colored-man-pages fd fzf-tab fzf z.lua
gitfast common-aliases python pip
zsh-recycle-bin zsh-hist colorize
